...
to the head part of your layout, setting options as necessary.
...
in your controllers.  You can do this once in ApplicationController to get this behaviour across all controllers.  If you need to override the default options you will need to define a new filter method.
